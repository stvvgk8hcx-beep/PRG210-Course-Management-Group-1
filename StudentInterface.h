...
// This features the student interface, allowing a student to interact 
// with their course cart and browse departments.
class StudentInterface : public Interface {
// Each StudentInterface object has a Cart object to manage
// the student's selected courses.
private:
    Cart studentCart;
...
// providing the main loop for the student interface.
public:
    void run() override; 
};
